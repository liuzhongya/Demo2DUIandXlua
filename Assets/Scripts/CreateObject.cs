...
public class CreateObject : MonoBehaviour {
   ...
   public  string  CutStr(string strName)
    ...
    //    GameObject go = Resources.Load<GameObject>(path);
    //      Instantiate(m_prefab, m_parent);

        //if(CutStr(gameObject.name)== "Dirt1")
        //{
        //    print("这是Dirt的");
        //}
        if (gameObject.name == "Dirt1" || gameObject.name == "Dirt2b")
        {
            ...
            else if(randomCreate>10&& randomCreate<=25)  //生成金币
            {
               NewObject("Coin",new Vector3(0, 2, 0));         
                 
            }
            //else if (randomCreate > 20 && randomCreate <= 27)  //敌人一   
            //{
            //    NewObject("opossum", new Vector3(0, 2, 0));
            //}
            //else if (randomCreate > 27 && randomCreate <= 34)  //敌人 er 
            //{
            //    NewObject("frog", new Vector3(0, 1.7f, 0));
            //}
            //else if (randomCreate > 34 && randomCreate <= 40)  //敌人三
            //{
            //    NewObject("eagle", new Vector3(0, 2, 0));
            //}

        }
      else   if (gameObject.name == "Dirt2a"|| gameObject.name == "Dirt3a" || gameObject.name == "Dirt3b"|| gameObject.name == "Dirt3c")
        {
            if (randomCreate > 6 && randomCreate < 10)  //生成宝箱
            {
                //    string path = ResourcesDir + "/" + "Coin";
      ...
      else   if (gameObject.name == "Dirt7a")
        {
            if (randomCreate > 6 && randomCreate < 10)  //生成宝箱
            {
                //    string path = ResourcesDir + "/" + "Coin";
